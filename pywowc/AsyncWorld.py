...
class WorldHandler(asyncore.dispatcher):
    ...
    def CS_MESSAGE_EMOTE(self, emote_id):
        data = struct.pack(
            ST_MESSAGE_EMOTE[0],
            OP_MESSAGE_EMOTE,
            emote_id,               # Id of the emote
            0,                      # Variation
            0,                      # Target of the emote
        )
    ...
    def CS_ITEM_QUERY_SINGLE(self, entry):
        data = struct.pack(
            ST_ITEM_QUERY_SINGLE[0],
            OP_ITEM_QUERY_SINGLE,
            entry,
            0,
        )
    ...
    def SS_INIT_WORLD_STATES(self, data):
        ...
        #self.CS_JOIN_CHANNEL('quizz')
        #self.CS_MESSAGE_CHAT(14, 'world', 'Hello World !', 0)                       # Message on channel world
        #self.CS_MESSAGE_CHAT(0, '', '.announce Hello World !', 0)    # Say message
        #self.CS_MESSAGE_EMOTE(34)
        self.CS_ITEM_QUERY_SINGLE(19019)
