...
class ProxyLostConnectionError(Exception):
    pass
...
class OutgoingProxyCache:
    ...
    def getOutgoing(self, host, port):
        ...
        if (host, port) == (self.last_host, self.last_port):
            ...
            reactor.connectSSL(host, port, outgoing_factory, ClientContextFactory(),timeout=CONNECTION_TIMEOUT)
...
if __name__ == '__main__':
    ...
    reactor.listenSSL(LISTEN_PORT, IncomingFactory(), context)
    reactor.run()
